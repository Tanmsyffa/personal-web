<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Sultan T. Musyaffa</h1>
      <div class="py-2">
        <h1
    ...
    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
        class="w-10/12 md:h-auto rounded-full border-4 border-amber-200 pict" src="https://img.freepik.com/free-photo/3d-illustration-boy-with-camera-his-hand_1142-36694.jpg?w=740&t=st=1721064022~exp=1721064622~hmac=8460ce8262ba1bd321128424b5652d25c2be556659265fc483ca18674ad1e089">
    </div>
  </main>
</template>
...
export default {
  ...
  data() {
    return {
      toRotate: ["Informatics Student", "Tech Enthusiast", "Android Enthusiast"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
